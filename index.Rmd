...
pbmc <- RenameIdents(data, new.cluster.ids)
DimPlot(pbmc, reduction="umap", label=TRUE, pt.size=0.5) + NoLegend()
```
NOus allons ensuite regarder les interactions ligand-récepteur que ces popul existante entre 
Une fois cela fait, installez le paquet SingleCellSignalR Bioconductor et déterminez les interactions ligand-récepteur que ces populations de cellules ont entre elles. Il y en aura beaucoup.
