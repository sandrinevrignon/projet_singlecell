...
Lorsque l'on combine les données en confondant les types cellulaire, on observe mieux certaines valeurs extrême. Afin d'éviter certains biais d'analyses nous allons effectué un filtre de ces données normalisées en retirant les valeurs les plus extrêmes en filtrant nos données. Pour cela, nous allons filtrer sur le nombre total de molécules afin que celui-ci soit inférieure à 25 000 et un pourcentage de mitochondrie inférieure à 10% ou les valeurs sont assez rare (nous prenons le risque de retirer certaines valeurs pour la population HN7 qui possède un taux de mitochondrie différents)
