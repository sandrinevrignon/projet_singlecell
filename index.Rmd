...
Ainsi parmi les gènes déterminé nous retrouvons les gènes suivants: - GZMB: (Granzime B) qui est exprimé par les lymphocytes T cytotoxique (CTL) et les cellules NK (Natural Killers) - JCHAIN (chaîne de jonction): qui est composant protéique exprimé pour les immunoglobuline. -LILRA4 (Leukocyte immunoglobulin-like receptor subfamily A member 4) : gène qui est préférentiellement exprimée chez les leucocytes et plus directement les macrophages. -ITM2C (Integral Membrane Protein 2C): intervient dans la signalisation cellulaire et la régulation de la réponse immunitaire TSPAN13 (Tetraspanin-13): joue un rôle dans la modulation de la signalisation cellulaire, l'adhésion et la migration des cellules immunitaires
...
Les marqueurs ainsi retrouvé sont les suivants: -CFD (Complement Factor D): retrouvé dans les macrophages, neutrophiles et cellules endothéliales. -CXCL2 (C-X-C Motif Chemokine Ligand 2): retrouvé dans les Neutrophiles, monocytes, et macrophages. -CCL19 (C-C Motif Chemokine Ligand 19): retrouvé dans Lymphocytes T, cellules dendritiques, et lymphocytes B -LAD1 (Leukocyte Adhesion Deficiency 1): retrouvé dans les leucocytes -PACSIN1 (Protein Kinase C and Casein Kinase Substrate In Neurons 1): retrouvé dans les macrophages, dendritiques. -TCL1A (T-cell Leukemia 1A): retrouvé dans les cellules dendritique -UBE2C (Ubiquitin-Conjugating Enzyme E2C): non spécifiques -CDC2 (Cell Division Cycle 2):retrouvé dans les cellules des lymphocytes T
...
Lorsque nous effectuons cette visualisation sur l'UMAP nous pouvons observer les même tendance. Ainsi on peut déterminer d'après les résultats et la fontion des gènes les différents groupes immunitaires: -Le groupe 0 (cluster 0) correspondrait aux macrophage, neutrophile et monocyte -Le groupe 1 (cluster 1) correspondrait aux lymphocytes B -Le groupe 2 (cluster 2) correspondrait aux cellules dendritiques -Le groupe 3 (cluster 3) correspondrait aux lymphocyte T
...
En limitant l'analyse uniquement à ces deux gènes nous pouvons observer que SPP1 possède un niveau d'expression très élevé au niveau des macrophage et des Lymphocyte T. Ces résultats pouvant être expliqué par l'interaction que nous avons entre les 2 populations. En ce qui concerne CXCL9 nous pouvons observer que le niveau d'expression est un peu plus élevé au niveau des macrophage.

```{r}
FeaturePlot(data, features=c("SPP1","CXCL9"))
```

C'est résultat sont assez bien corrélé avec les résultats d'expression présente sur l'UMAP. Ainsi l'expression n'est pas forcément corrélé à un type cellulaire mais en lien avec les interaction des autres populations.
