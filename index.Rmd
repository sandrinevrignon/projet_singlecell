...
Ces résultats sont assez bien corrélés avec les résultats d'expression présents sur l'UMAP. On peut également constater à travers cette représentation que ces marqueurs spécifiques des macrophages sont localisés en très grande majorité dans la région inferieure du cluster. Ainsi l'identification de l'expression des gènes spécifiques met non seulement en évidence les types cellulaires mais aussi les interactions entre plusieurs types cellulaires qui sont influencés par ces expressions.

## Conclusion

Cette analyse a permis de caractériser des populations cellulaires et leurs interactions à partir de données normalisées. En identifiant 2000 gènes les plus variables, nous avons pu distinguer quatre clusters principaux, visualisés via UMAP. Les marqueurs spécifiques (ex. CFD, CXCL2) ont permis d’annoter les types cellulaires, notamment les macrophages, identifiés grâce à l'expression de SPP1 et CXCL9.
